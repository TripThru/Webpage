...
SwaggerResource.prototype.addOperations = function(resource_path, ops, consumes, produces) {
  if (ops) {
    ...
    for (var i = 0; i < ops.length; i++) {
      ...
      op = new SwaggerOperation(o.nickname, o.socketAction, resource_path, method, o.parameters, o.summary, o.notes, type, responseMessages, this, consumes, produces, o.authorizations);
...
var SwaggerOperation = function(nickname, socketAction, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces, authorizations) {
  var _this = this;

  var errors = [];
  this.nickname = (nickname||errors.push("SwaggerOperations must have a nickname."));
  this.socketAction = (socketAction||errors.push("SwaggerOperations must have a socketAction."));
...
var SwaggerRequest = function(type, url, params, opts, successCallback, errorCallback, operation, execution) {
  ...
  var socketAction = this.opts.parent.model.socketAction;
...
SwaggerHttp.prototype.execute = function(obj) {
  ...
  else if(obj.useSocketIO)
    return new SocketIOClient().execute(obj);
  else
...
SocketIOClient.prototype.execute = function(obj) {
  var cb = obj.on;
  var request = JSON.parse(obj.body);

  socket.emit(obj.socketAction, request, function(response){
    cb.response({
      headers: {
        'Content-Type': 'application/json'
      },
      url: '/' + obj.socketAction,
      method: 'post',
      status: 200,
